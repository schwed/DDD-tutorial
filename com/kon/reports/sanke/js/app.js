/**
 * Created by kshevchuk on 7/21/2015.
 */
    ...
    window.utils = {
        loadTemplate: function (a, b) {
            var c = [];
            $.each(a, function (a, b) {
                window[b] ? c.push($.get("tpl/" + b + ".html", function (a) {
                    window[b].prototype.template = _.template(a)
                })) : alert(b + " not found")
            }), $.when.apply(null, c).done(b)
        },

        displayValidationErrors: function (a) {
            for (var b in a)a.hasOwnProperty(b) && this.addValidationError(b, a[b]);
            this.showAlert("Warning!", "Fix validation errors and try again", "alert-warning")
        },

        addValidationError: function (a, b) {
            var c = $("#" + a).parent().parent();
            c.addClass("error"), $(".help-inline", c).html(b)
        },

        removeValidationError: function (a) {
            var b = $("#" + a).parent().parent();
            b.removeClass("error"), $(".help-inline", b).html("")
        },

        showAlert: function (a, b, c) {
            $(".alert").removeClass("alert-error alert-warning alert-success alert-info"), $(".alert").addClass(c), $(".alert").html("<strong>" + a + "</strong> " + b), $(".alert").show()
        },
    ...
    window.MdObject = Backbone.Model.extend({
        ...
        validateAll: function () {
            ...
            return _.size(a) > 0 ? {isValid: !1, messages: a} : {isValid: !0}
        }
    }),
    ...
    window.AdminDatamapView = Backbone.View.extend({
        ...
        render: function () {
            return $(this.el).html(this.template($.extend({cnt: this.options.cnt}, {txt: this.options.txt}, {object_id: this.options.object_id}))), this
        }
    }),
    ...
    window.DepGraphHeadView = Backbone.View.extend({
        ...
        render: function () {
            ...
            cdList = this.options.cd, graphType = this.options.rcd, "1" == graphType && (graphName = "", relName = "Lineage"), "2" == graphType && (graphName = "", relName = "Impact");
            ...
            return $(this.el).html(this.template($.extend({cnt: this.options.cnt}, {title: this.options.title}, {parent: this.options.parent}, {name: this.options.name}, {object_id: this.options.object_id}, {cd: this.options.cd}, {rcd: this.options.rcd}, {iconName: a}))), this
        },
        events: {"click .reload": "clickReload", "click .lineage": "clickLineage", "click .impact": "clickImpact"},
        ...
        clickReload: function () {
            ...
            console.log("Types Checked: ", cdList),
                app.navigate("#graph/" + graphType + "/" + cdList + "/" + selId, {trigger: !0})
        },

        clickLineage: function () {
            console.log("Click Lineage..."),
            1 != graphType && app.navigate("#graph/1/" + cdList + "/" + selId, {trigger: !0})
        },

        clickImpact: function () {
            console.log("Click Impact..."),
            2 != graphType && app.navigate("#graph/2/" + cdList + "/" + selId, {trigger: !0})
        }
    }),
    ...
    window.DepGraphView = Backbone.View.extend({
        ...
        render: function () {
            function a(a) {
                d3.select(this)
                    .attr("transform", "translate(" + a.x + "," + (a.y = Math.max(0, Math.min(j - a.dy, d3.event.y))) + ")"),
                    m.relayout(),
                    p.attr("d", o)
            }
            ...
            function b(a) {
                n.transition().duration(200)
                    ...
                    n.html("<div class='popup-label'>"
                        ...
                        + "</span></div><div class='popup-line'><span class='popup-label'>Conditions </span><span class='popup-value'>"
                        + a.condition_ds + "</span></div>")
            ...
            function c(a) {
                n.transition().duration(200)
                    ...
                    n.html("<div class='popup-label'>" + a.type_nm.toUpperCase()
                        + " (" + a.type_cd + ")</div><div class='popup-line'><span class='popup-title'>"
                        + a.parent_nm + "." + a.object_nm
            ...
            var e = this.model.models, f = (e.length, e[0].get("nodes")), g = e[0].get("links");

            console.log("Qraph Query JSON Length (KB): " + JSON.stringify(e).length / 1024),
            console.log("Qraph Query JSON content: " + JSON.stringify(e)),
            ...
            var h = {
                ...
                l = d3.select(this.el)
                    .append("svg")
                    .attr("width", i + h.left + h.right)
                    .attr("height", j + h.top + h.bottom)
                    .append("g")
    ...
    window.DepNavView = Backbone.View.extend({
        ...
        render: function () {
            var a = this.model.models, b = a.length;
            $(this.el).html(this.options.id > 0 ? '<div class="well sidebar-nav"><ul class="nav nav-list"><li><a href="#dependencies/t/2/163,1013,1015,1603/'
            + this.options.id
            + '"><i class="icon-chevron-left icon-black"></i><strong>'
            + this.options.nm + '</strong></a></li><li class="active"><a href="#dependencies/t/2/163,1013,1015,1603/'
            + a[0].get("parent_id").toString()
            + '"><i class="icon-current icon-white"></i><strong>'
            + a[0].get("parent_nm").toString()
            + "</strong></a></li></ul></div>" : a[0].get("parent_id") > 0 ? '<div class="well sidebar-nav"><ul class="nav nav-list"><li><a href="#dep/0"><i class="icon-home icon-black"></i><strong>Root Objects</strong></a></li><li class="active"><a href="#dependencies/t/2/163,1013,1015,1603/'
            + a[0].get("parent_id").toString()
            + '"><i class="icon-current icon-white"></i><strong>'
            + a[0].get("parent_nm").toString()
            + "</strong></a></li></ul></div>" : '<div class="well sidebar-nav"><ul class="nav nav-list"><li class="active"><a href="#dep/0"><i class="icon-home icon-black"></i><strong>Root Objects</strong></a></li></ul></div>');
            for (var c = "", d = 0; b > d; d++)
                a[d].get("type_id") >= 1e3 && a[d]
                    .get("type_id") <= 2e3 && (c != a[d]
                    .get("type_nm").toString() && $(".nav-list", this.el)
                    .append('<li class="nav-header">' + a[d].get("type_nm").toString() + "</li>"),
                    c = a[d].get("type_nm").toString(),
                    $(".nav-list", this.el)
                    .append(new DepNavItemView({
                        model: a[d],
        ...
        render: function () {
            ...
            return b.length >= 27 && 0 == g && (b = b.substring(0, 28) + ".."),
                    ...
                    this.options.objectId == a ? $(this.el)
                        .addClass("active")
                        .html(g > 0 ? '<a href="#dependencies/t/2/'
                        + d + ",163,1013,1015,1603/"
                        + a + '" title="'
                        + c + '"><i class="' + f + '"></i>'
                        + b + "(" + g + ")</a>" : '<a href="#dependencies/t/2/'
                        + d + ",163,1013,1015,1603/"
                        + a + '" title="' + c + '"><i class="' + f + '"></i>'
                        + b + "</a>") : $(this.el)
                        .html(g > 0 ? '<a href="#dependencies/t/2/'
                        + d + ",163,1013,1015,1603/"
                        + a + '" title="' + c + '"><i class="' + f + '"></i>'
    ...
    window.DepTreeHeadView = Backbone.View.extend({
        ...
        render: function () {
            var a = "icon-" + this.options.title.toLowerCase().replace(" ", "-");
            return console.log("DepTreeHeadView: ", this.options.title), $(this.el).html(this.template($.extend({cnt: this.options.cnt}, {title: this.options.title}, {parent: this.options.parent}, {name: this.options.name}, {object_id: this.options.object_id}, {cd: this.options.cd}, {rcd: this.options.rcd}, {dir: this.options.dir}, {iconName: a}))), this
        },
        events: {"click .reload": "clickReload", "click .lineage": "clickLineage", "click .impact": "clickImpact"},
        ...
        clickReload: function () {
            ...
            for (var a = 0; a < $(".ObjectTypeDropdown").dropdownCheckbox("checked").length; a++)
                cdList = null == cdList ? $(".ObjectTypeDropdown").dropdownCheckbox("checked")[a].cd : cdList + "," + $(".ObjectTypeDropdown").dropdownCheckbox("checked")[a].cd;
            console.log("Types Checked: ", cdList),
            app.navigate("#treegraph/" + this.options.dir + "/" + this.options.rcd + "/" + cdList + "/" + this.options.object_id, {trigger: !0})
        },
        ...
        render: function () {
            function a(a) {
                if (a.children) {
                    ...
                    var c = u.transition().duration(d3.event.altKey ? 7500 : 750)
                        .attr("transform", function (a) {
            ...
            var c = this.model.models,
                d = (c.length, this.options.rcd),
                e = this.options.id,
                f = (this.options.cd, this.options.dir),
                g = (e.split(",").length, c[0].get("pid").children.length),
                h = JSON.stringify(c[0].get("pid")).match(/\"name\"\:/g).length;
            if (cdList = this.options.cd, "s" == f);
            if ("t" == f);
            if ("1" == d) var i = "";
            if ("2" == d) var i = "";
            for (var j = [
                {id: "1", label: "ETL Package", isChecked: !1, cd: 1400},
                {id: "2", label: "ETL Task", isChecked: !1, cd: 1401},
                {id: "3", label: "Mapping Group", isChecked: !1, cd: 150},
                {id: "4", label: "Mapping", isChecked: !1, cd: 151},
                {id: "5", label: "Schema", isChecked: !1, cd: 1004},
                {id: "6", label: "File", isChecked: !1, cd: 163},
                {id: "7", label: "Table", isChecked: !1, cd: 1015},
                {id: "8", label: "View", isChecked: !1, cd: 1013},
                {id: "9", label: "Column", isChecked: !1, cd: 1016},
                {id: "10", label: "BI Folder", isChecked: !1, cd: 1601},
                {id: "11", label: "BI Report", isChecked: !1, cd: 1603},
                {id: "12", label: "BI Object", isChecked: !1, cd: 1604}
            ...
            var u = r.selectAll("g")
                ...
                .on("click", a),
                v = n / root.dx, w = o / 1;
            return u.append("svg:rect")
                .attr("width", root.dy * v)
                .attr("height", function (a) {
                        return a.dx * w
                })
    ...
    window.DepHeadView = Backbone.View.extend({
        ...
        render: function () {
            var a = "icon-" + this.options.title.toLowerCase().replace(" ", "-");
                ...
                "1" == graphType && (graphName = "", relName = "Lineage"),
                "2" == graphType && (graphName = "", relName = "Impact");
            for (var b = cdList.split(","), c = 0; c < depTab.length; c++)
                for (var d = 0; d < b.length; d++)
                    if (depTab[c].cd == b[d]) {
                        depTab[c].isChecked = !0;
        ...
        clickReload: function () {
            ...
            console.log("Types Checked: ", cdList),
            app.navigate("dependencies/s/" + this.options.rcd + "/" + cdList + "/" + this.options.object_id, {trigger: !0})
        },
        clickLineage: function () {
            console.log("Click Lineage..."),
            1 != this.options.rcd && app.navigate("dependencies/s/1/" + this.options.cd + "/" + this.options.object_id, {trigger: !0})
        },
        clickImpact: function () {
            console.log("Click Impact..."),
            2 != this.options.rcd && app.navigate("dependencies/s/2/" + this.options.cd + "/" + this.options.object_id, {trigger: !0})
        }
    }), // end of DepHeadView
    ...
    window.DepSubHeadView = Backbone.View.extend({
        ...
        render: function () {
            return $(this.el).html(this.template($.extend({cnt: this.options.cnt}, {txt: this.options.txt}, {object_id: this.options.object_id}, {cd: this.options.cd}))),
                this
        }
    }),
    ...
    window.DepFromView = Backbone.View.extend({
        ...
        render: function () {
            ...
            if (1 > b)
                ...
                var c = b;
            $(".srcSize").html(b), $(this.el).append(new DepSubHeadView({
            ...
            for (var d = 0; b > d; d++)
                "" != a[d].get("object_nm").toString() && $(".table", this.el)
                    .append(new DepItemView({
                        model: a[d],
    ...
    window.DepToView = Backbone.View.extend({
        ...
        render: function () {
            ...
            if (1 > b)
                ...
                var c = b;
            $(".tgtSize").html(b), $(this.el).append(new DepSubHeadView({
                txt: '<i class="icon-chevron-right icon-black"></i> Dependent Targets',
                cnt: c,
                object_id: this.options.id,
                cd: this.options.cd
            }).render().el);
            for (var d = 0; b > d; d++)"" != a[d].get("object_nm").toString() && $(".table", this.el).append(new DepItemView({
                model: a[d],
                dir: this.options.dir,
                rcd: this.options.rcd,
                cd: this.options.cd
    ...
    window.DepItemView = Backbone.View.extend({
        ...
        render: function () {
            ...
            return $(this.el).html(this.template($.extend(this.model.toJSON(), {queryCnt: b}, {iconName: a}, {dir: this.options.dir}, {rcd: this.options.rcd}, {cd: this.options.cd}))), this
        }
    }),
    ...
    window.GlossaryRootView = Backbone.View.extend({
        ...
        render: function () {
            ...
            for (var c = "", d = 0; b > d; d++)
                c != a[d].get("type_nm").toString() && $(".nav-list", this.el)
                    .append('<li class="nav-header">' + a[d].get("type_nm").toString() + " GLOSSARY</li>"),
                    c = a[d].get("type_nm").toString(),
                "" != a[d].get("object_nm").toString() && $(".nav-list", this.el)
                    .append('<li><a href="#glossary/' + a[d].get("object_id").toString() + '" title="' + a[d].get("object_ds") + '""><i class="icon-conceptsystem"></i>' + a[d].get("object_nm").toString().substr(0, 25) + "(" + a[d].get("glossary_cnt").toString() + "/" + a[d].get("concept_cnt").toString() + ")</a></li>")
        }
    }),
        ...
        render: function () {
            ...
            for (var c = "", d = 0; b > d; d++)
                c != a[d].get("type_nm").toString() && $(".nav-list", this.el)
                    ...
                    c = a[d].get("type_nm").toString(),
                "" != a[d].get("object_nm").toString() && $(".nav-list", this.el)
                    .append(new GlossaryTreeItemView({
                        model: a[d],
        ...
        render: function () {
            ...
            for (var d = 0; b > d; d++)
                "" != a[d].get("object_id").toString() && $(".table", this.el)
                    .append('<tr><td><i class="icon-concept"></i> <a href="#objects/' + a[d].get("object_id").toString() + '" title=" Last changed at ' + a[d].get("changed_dt").toString() + " by " + a[d].get("changed_by").toString() + '""><strong>' + a[d].get("object_nm").toString().substring(0, 35) + "</strong></a></td><td>" + a[d].get("object_ds").toString().substr(0, 200) + "</td><td>" + a[d].get("relation_cnt") + "</td></tr>");
            return this
        }
    }),
    ...
    window.HeaderView = Backbone.View.extend({
        ...
        selectMenuItem: function (a) {
            $(".nav li").removeClass("active"), a && $("." + a).addClass("active"),
            $("#search-input")
                .on("submit", function (a) {
                    var b = $(".navbar-search #search-input").val();
                    return app.navigate("#search/" + b, {trigger: !0}), a.preventDefault(), !1
                })
        }
    }),
    ...
    window.ObjectEditView = Backbone.View.extend({
        ...
        events: {change: "change", "click .save": "beforeSave", "click .cancel": "cancelEdit"}, change: function (a) {
            utils.hideAlert();
            var b = a.target, c = {};
            c[b.name] = b.value, this.model.set(c);
        ...
        beforeSave: function () {
            ...
            return a.isValid === !1 ? (utils.displayValidationErrors(a.messages), !1) : (this.saveObject(), !1)
        },
        saveObject: function () {
    ...
    window.ObjectRootView = Backbone.View.extend({
        ...
        render: function () {
            ...
            for (var c = "", d = 0, e = "", f = 0, g = 0; b > g; g++)
                "" != e && c != a[g].get("gen_type_nm").toString() && $(".list", this.el)
                    .append('<li class="nav-header">' + a[g].get("gen_type_nm").toString() + "</li>"),
                "" != e && e != a[g].get("type_nm").toString() && ($(".list", this.el)
                    .append(new ObjectRootItemView({
                        type_id: d,
                        type_nm: e,
                        type_cnt: f
                    }).render().el), f = 0),
    ...
    }), // end of ObjectRootView

    window.ObjectRootItemView = Backbone.View.extend({
        tagName: "li", initialize: function () {
        },
    ...
    window.PropertyView = Backbone.View.extend({
        ...
        render: function () {
            ...
            if (b > 0 && "" != a[0].get("property_type_nm").toString()) {
                $(this.el).html('<div class="property-head"></div>'), $(this.el).append('<table class="table table-condensed"><thead class="property-head"><tr><th style="width: 20%">Property Name</th><th style="width: 70%">Description Text</th><th style="width: 5%">Lang</th><th style="width: 5%">Unit</th></thead></table>');
                for (var c = 0; b > c; c++)
                    "" != a[c].get("property_type_nm").toString() && $(".table", this.el)
                    .append(new PropertyItemView({model: a[c]}).render().el)
            }
            return this
        }
    }),
    ...
    window.RelationBarView = Backbone.View.extend({
        ...
        render: function () {
            ...
            for (var c = "", d = -1, e = 0; b > e; e++)
                d != a[e].get("reverse_ind") && 0 == a[e].get("reverse_ind") && $(".nav-list", this.el).append('<li class="active"><a><i class="icon-chevron-right icon-white"></i><strong>RelatedTo</strong></a></li>'), d != a[e].get("reverse_ind") && 1 == a[e].get("reverse_ind") && $(".nav-list", this.el).append('<li class="active"><a><i class="icon-chevron-right icon-white"></i><strong>RelatedFrom</strong></a></li>'), c != a[e].get("relation_type_nm").toString() && $(".nav-list", this.el).append('<li class="nav-header">' + a[e].get("relation_type_nm") + "</li>"), 0 == a[e].get("reverse_ind") && $(".nav-list", this.el).append('<li><a href="#objects/' + a[e].get("related_object_id") + '">' + a[e].get("related_object_nm").substring(0, 30) + "</a></li>"), 1 == a[e].get("reverse_ind") && $(".nav-list", this.el).append('<li><a href="#objects/' + a[e].get("object_id") + '">' + a[e].get("object_nm").substring(0, 30) + "</a></li>"), c = a[e].get("relation_type_nm"), d = a[e].get("reverse_ind");
            return this
        }
    }),
    ...
    window.SearchResultView = Backbone.View.extend({
        ...
        render: function () {
            ...
            for (var i = d; e > i; i++)
                if (f = DepTypeList.toString().indexOf(b[i].get("object_type_cd")) >= 0 ? ', Apps: ( <a href="#graph/2/' + b[i].get("object_type_cd") + ",163,1015,1013,1603/" + b[i].get("object_id") + '" title="Jump to Dependency Graph..."><img src="img/graph-right-small.png"></a> |                             <a href="#dependencies/t/2/' + b[i].get("object_type_cd") + ",163,1015,1013,1603/" + b[i].get("object_id") + '" title="Jump to Dependency Table..."><img src="img/table-small.png"></a> )' : "", g = BusTypeList.toString().indexOf(b[i].get("object_type_cd")) >= 0 ? 170 == b[i].get("object_type_cd") ? ', Apps: ( <a href="#glossary/' + b[i].get("parent_object_id") + '" title="Jump to Business..."><img src="img/business-small.png"></a> )' : ', Apps: ( <a href="#glossary/' + b[i].get("object_id") + '" title="Jump to Business..."><img src="img/business-small.png"></a> )' : "", "" != b[i].get("object_nm").toString()) {
            ...
            }).render().el), $(this.el).append("* Results limited with first " + c + " matches. Ordered and ranked by better match and shorter title/name.")),
                this
        }// end of render
    }), // end of SearchResultView
    ...
    window.ObjectPathView = Backbone.View.extend({
        ...
        render: function () {
            var a = "#objects/", b = this.model.models, c = b.length;
    ...
    var DepTypeList = [1003, 1004, 1010, 1013, 1015, 1016, 1017, 150, 151, 1603, 1607, 1608, 1609],
        ...
        depTab = [
            {id: "1", label: "ETL Package", isChecked: !1, cd: 1400},
            {id: "2", label: "ETL Task", isChecked: !1, cd: 1401},
            {id: "3", label: "Schema", isChecked: !1, cd: 1004},
            {id: "4", label: "File", isChecked: !1, cd: 163},
            {id: "5", label: "Table", isChecked: !1, cd: 1015},
            {id: "6", label: "View", isChecked: !1, cd: 1013},
            {id: "7", label: "Column", isChecked: !1, cd: 1016},
            {id: "8", label: "BI Folder", isChecked: !1, cd: 1601},
            {id: "9", label: "BI Report", isChecked: !1, cd: 1603},
            {id: "10",label: "BI Object", isChecked: !1, cd: 1604}
        ],
        glossaryId = 20408793,
        graphType = "2",
        selId = 2,
    ...
    AppRouter = Backbone.Router.extend({
        ...
        path: function (a) {
            var b = new MdObjectPathCollection([], {id: a});
            b.fetch({
                id: a, success: function () {
                    $("ObjectPath").html(new ObjectPathView({model: b, id: a}).el)
                }
            })
        },

        tree: function (a, b) {
            this.subHeaderView = new SubHeaderView({id: a}),
            ...
            var c = new MdTreeObjectCollection([], {id: a, cd: b});
            c.fetch({id: a, cd: b,
                success: function () {
                    $(".ObjectTree").append(new ObjectTreeView({model: c}).el)
                }
            });
            var d = new MdStatCollection([]);
            d.fetch({
                success: function () {
                    $(".Statistics").html(new ObjectStatView({model: d}).el)
                }
            })
        },
        search: function (a, b) {
            var c = b ? parseInt(b, 10) : 1, d = new MdSearchCollection([], {name: a});
            d.fetch({
                success: function () {
                    $("#content").html(new SearchResultView({model: d, name: a, page: c}).el)
                }
            }),
            this.headerView.selectMenuItem()
        },
        ...
        list: function (a) {
            ...
            c.fetch({
                success: function () {
                    $("#content").html(new ObjectListView({model: c, page: b}).el)
                }
            }),
        ...
        objectDetails: function (a) {
            ...
            $("#content").append((new ObjectPageView).el), a >= 0)
            var c = a;
            else
            var c = 0,
                a = 0;
            selId = a;
            var d = new MdObject([], {id: c});
            d.fetch({
                success: function () {
                    ...
                    $(".ObjectDetail").html(new ObjectView({model: d, parentNm: d.get("parent_object_nm")}).el);
                    var f = new MdTreeObjectCollection([], {id: b});
                    f.fetch({
                        success: function () {
                            $(".ObjectTree").append(new ObjectTreeView({model: f, objectId: a, id: e, nm: c}).el)
                        }
                    });
                    var g = new MdPropertyCollection([], {id: a});
                    g.fetch({
                        success: function () {
                            $(".ObjectProperty").append(new PropertyView({model: g}).el)
                        }
                    });
                    var h = new MdRelationCollection([], {id: a});
                    h.fetch({
                        success: function () {
                            $(".ObjectRelation").append(new RelationView({model: h}).el)
                        }
                    })
                } // end of success
            }) // end of outer fetch
        }, // end of objectDetails

        objectEdit: function (a, b) {
            var c = new MdObject([], {id: b, edit: a});
            c.fetch({
                success: function () {
                    $(".ObjectDetail").html(new ObjectEditView({model: c}).el),
                    $(".ObjectRelation").html()
                }
            }),
            this.headerView.selectMenuItem()
        ...
        addObject: function () {
            var a = new MdObject;
            $("#content").html(new ObjectView({model: a}).el),
        ...
        glossaryHome: function (a) {
            ...
            $("#content").append((new GlossaryHomeView).el), null == a || 0 == a) {
                var c = new MdGlossaryCollection([], {id: a});
                c.fetch({
                    success: function () {
                        $("#GlossaryHead").append((new GlossaryHeadView).el), $("#GlossaryTree").html(new GlossaryRootView({
                            model: c,
                            id: a
                        }).el)
                    }
            ...
            if (a > 0)  {
                var d = 0,
                    ...
                    f = 0,
                    g = "",
                    h = new MdGlossary([], {id: a});
                h.fetch({
                    success: function () {
                        h.get("glossary_cnt") > 0 ? (d = h.get("object_id").toString(), e = h.get("object_nm").toString(), f = h.get("parent_object_id").toString(), g = h.get("parent_object_nm").toString()) : (d = 0, e = "");
                        var b = new MdGlossaryCollection([], {id: d});
                        b.fetch({
                            success: function () {
            ...
            if (null != a && 0 != a) {
                var i = new MdConceptCollection([], {id: a});
                i.fetch({
                    success: function () {
                        $("#GlossaryBody").html(new GlossaryView({model: i, id: a, id: d, nm: e}).el)
                    }
                })
            }
        }, // end of glossaryHome
        ...
        dep: function (a, b) {
            ...
            var c = new MdObjectPathCollection([], {id: a});
            c.fetch({
                id: a, success: function () {
                    $("#ObjectPath").html(new ObjectPathView({model: c, id: a}).el)
                }
            }),
            $("#content").append((new DepAppView).el),
            $(".DepHome").append((new DepAppHomeView).el);
            var d = new MdTreeObjectCollection([], {id: a, cd: b});
            d.fetch({
                id: a, cd: b, success: function () {
                    $(".DepNav").append(new DepNavView({model: d}).el)
                }
            }),
            this.headerView.selectMenuItem("analytics-menu")
        },
        ...
        depTable: function (a, b, c, d) {
            selId = d, this.subHeaderView = new SubHeaderView({id: d}),
            $("#content").html(this.subHeaderView.el),
            this.headerView.selectMenuItem("analytics-menu"),
            this.subHeaderView.selectMenuItem("dep-tbl-menu");
            var e = new MdObjectPathCollection([], {id: d});
            if (e.fetch({id: d,
                    success: function () {
                        $("#ObjectPath").html(new ObjectPathView({model: e, id: d}).el)
                    }
                }),
                $("#content").append((new DepAppView).el), d >= 0
            )
                var f = d;
            else
                var f = 0, d = 0;
            var g = new MdObject([], {id: f});
            g.fetch({
                success: function () {
                    ...
                    var h = new MdTreeObjectCollection([], {id: a});
                    h.fetch({
                        success: function () {
            ...
            var h = new MdDepFromCollection([], {dir: "s", rcd: b, cd: c, id: d});
            h.fetch({
                success: function () {
            ...
            var i = new MdDepToCollection([], {dir: "t", rcd: b, cd: c, id: d});
            i.fetch({
                success: function () {
        ...
        depTree: function (a, b, c, d) {
            ...
            f.fetch({
                success: function () {
                    ...
                    var i = new MdTransfCollection([], {dir: a, rcd: b, cd: c, id: d});
                    i.fetch({
                        success: function () {
        ...
        depGraph: function (a, b, c) {
            // this one gets data for sankey diagram
            selId = c,
            this.subHeaderView = new SubHeaderView({id: c}),
            $("#content").html(this.subHeaderView.el),
            this.headerView.selectMenuItem("analytics-menu"),
            this.subHeaderView.selectMenuItem("dep-graph-menu");
            var d = new MdObjectPathCollection([], {id: c});
            d.fetch({
                id: c, success: function () {
                    $("#ObjectPath").html(new ObjectPathView({model: d, id: c}).el)
                }
            });
            var e = new MdObject([], {id: c});
            e.fetch({
                success: function () {
                    ...
                    var h = new MdGraphCollection([], {rcd: a, cd: b, pid: c});
                    h.fetch({
                        success: function () {
    ...
    }, // end of d3 snakey function

    !function (a) {
        "use strict";
        var b = '    <button class="dropdown-checkbox-toggle" data-toggle="dropdown" href="#">Dropdown trigger </button>    <div class="dropdown-checkbox-content">      <div class="dropdown-checkbox-header">        <input class="checkbox-all" type="checkbox"><input type="text" placeholder="Search" class="search"/>      </div>      <ul class="dropdown-checkbox-menu"></ul>    </div>', c = '<li><div class="layout"><input type="checkbox"/><label></label></div></li>', d = '<li><div class="layout"><label>No results.</label></div></li>', e = ' <span class="dropdown-checkbox-nbselected"></span>', f = function (c, d) {
            a(c).html(b), a(c).addClass("dropdown-checkbox dropdown"), this.$element = a(c).find(".dropdown-checkbox-toggle"), this.$parent = a(c), this.$list = this.$parent.find("ul"), this.elements = [], this.hasChanges = !1, this.showNbSelected = !1, "object" == typeof d && (this.$element.text(d.title), this.$element.addClass(d.btnClass), this.autosearch = d.autosearch, this.elements = d.data || [], this._sort = d.sort || this._sort, this.sortOptions = d.sortOptions, this.hideHeader = d.hideHeader || void 0 === d.hideHeader ? !0 : !1, this.templateButton = d.templateButton, this.showNbSelected = d.showNbSelected || !1), this.$element.append(e), this.templateButton && (this.$element.remove(), this.$parent.prepend(this.templateButton), this.$element = this.$parent.find(".dropdown-checkbox-toggle")), this.$element.attr("data-toggle", "dropdown"), this.hideHeader && this.$parent.find(".dropdown-checkbox-header").remove(), this.$parent.find(".dropdown-checkbox-content").on("click.dropdown-checkbox.data-api", function (a) {
                a.stopPropagation()
            }), this.$element.on("click.dropdown-checkbox.data-api", a.proxy(function () {
                var b = this.$parent.hasClass("open");
                return a(".dropdown").removeClass("open"), b && this.$parent.addClass("open"), this.$parent.toggleClass("open"), this.hasChanges && this.$parent.trigger("change:dropdown-checkbox"), this.hasChanges = !1, !1
            }, this)), this.$parent.find(".checkbox-all").on("change.dropdown-checkbox.data-api", a.proxy(function (a) {
                this.onClickCheckboxAll(a), this._showNbSelected()
            }, this)), a(document).on("click.dropdown-checkbox.data-api", a.proxy(function () {
                this.$parent.removeClass("open"), this.hasChanges && this.$parent.trigger("change:dropdown-checkbox"), this.hasChanges = !1
            }, this)), this.$parent.find(".dropdown-checkbox-header").on("keyup.dropdown-checkbox.data-api", a.proxy(f.prototype.onKeyup, this)), this.$parent.find("ul").delegate("li input[type=checkbox]", "click.dropdown-checkbox.data-api", a.proxy(function (a) {
                this.onClickCheckbox(a), this._showNbSelected()
            }, this)), this._reset(this.elements), this._showNbSelected()
        };
        f.prototype = {
            constructor: f, _sort: function (a) {
                return a
            }, _removeElements: function (a) {
                this._isValidArray(a);
                for (var b = [], c = !0, d = 0; d < this.elements.length; d++) {
                    for (var e = 0; e < a.length; e++)a[e] === parseInt(this.elements[d].id, 10) && (c = !1);
                    c && b.push(this.elements[d]), c = !0
                }
                this.elements = b
            }, _getCheckbox: function (a, b) {
                for (var c = [], d = 0; d < this.elements.length; d++)(a === this.elements[d].isChecked || b) && c.push(this.elements[d]);
                return c
            }, _isValidArray: function (b) {
                if (!a.isArray(b))throw"[DropdownCheckbox] Requires array."
            }, _findMatch: function (a, b) {
                for (var c = [], d = 0; d < b.length; d++)-1 !== b[d].label.toLowerCase().search(a.toLowerCase()) && c.push(b[d]);
                return c
            }, _setCheckbox: function (a, b) {
                for (var c = 0; c < this.elements.length; c++)if (b == this.elements[c].id) {
                ...
                this.$parent.find(".search").val(""), this._reset(this.elements)
            }, _appendOne: function (a) {
                var b = a.id, d = a.label, e = a.isChecked, f = (new Date).getTime() * Math.random();
                this.$list.append(c);
                var g = this.$list.find("li").last();
                g.data("id", b);
                var h = g.find("input");
                h.attr("id", f), e && h.attr("checked", "checked");
                var i = g.find("label");
                i.text(d), i.attr("for", f), this._showNbSelected()
            }, _append: function (b) {
                if (a.isArray(b)) {
                    b = this._sort(b, this.sortOptions);
                    for (var c = 0; c < b.length; c++)this._appendOne(b[c])
                } else this._appendOne(b)
            }, _reset: function (a) {
                this._isValidArray(a), this.$list.empty(), this._append(a), this._refreshCheckboxAll()
                ...
                var c = b.keyCode, e = a(b.target).val();
                if (e.length < 1 && 8 === c)return this._reset(this.elements);
                if (27 === c)return this._resetSearch();
                ...
                var c = a(b.target).is(":checked"), d = this.$parent.find("ul li"), e = this;
                d.each(function () {
                    a(this).find("input[type=checkbox]").prop("checked", c), e._setCheckbox(c, a(this).data("id"))
                }), this.$parent.trigger("checked:all", c), this.$parent.trigger(c ? "check:all" : "uncheck:all"), this.hasChanges = !0
            }, onClickCheckbox: function (b) {
                this._setCheckbox(a(b.target).prop("checked"), a(b.target).parent().parent().data("id")), this._refreshCheckboxAll(), this.$parent.trigger("checked", a(b.target).prop("checked")), this.$parent.trigger(a(b.target).prop("checked") ? "check:checkbox" : "uncheck:checkbox"), this.hasChanges = !0
            }, checked: function () {
                ...
                if (a.isArray(b))for (var c = 0; c < b.length; c++)this.elements.push(b[c]); else this.elements.push(b);
                this._append(b), this.hasChanges = !0
            }, remove: function (a) {
                this._isValidArray(a), this._removeElements(a), this._reset(this.elements), this.hasChanges = !0
            }, reset: function (b) {
                this.elements = a.isArray(b) ? b : [b], this._reset(b), this.hasChanges = !0
            }
        },
        a.fn.dropdownCheckbox = function (b, c) {
            var d = a(this),
                ...
                g = "object" == typeof b && b;
            return e || d.data("dropdownCheckbox", e = new f(this, g)), "string" == typeof b ? e[b](c) : this
        },
